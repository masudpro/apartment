...
import imageOne from "../Resources/Rectangle 407.png";
import imageTwo from "../Resources/Rectangle 408.png";
import imageThree from "../Resources//Rectangle 409.png";
import imageFour from "../Resources/Rectangle 410.png";
import axios from "axios";
  ...
  return (
    <div className="houseDetails">
      <div className="container">
        <div className="row">
          <div className="col-md-8 pb-5 text-left">
          ...
          <div className="col-md-4">
            <form
              className="submitForm text-center py-5 px-3"
